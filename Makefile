estimate_number_of_games_uct: estimate_number_of_games_uct.c random.o
	gcc -o estimate_number_of_games_uct estimate_number_of_games_uct.c -O3 random.o -lm -Wall
