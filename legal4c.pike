...
// Count the number of legal boards of the given height up to the given width.
// Write the results to stdout as they become available.
void count_legal_boards(int height, int width)
{
...
int main(int argc, array(string) argv)
{
  ...
  write("  n L(%d,n)\n", height);
  count_legal_boards(height, width);
