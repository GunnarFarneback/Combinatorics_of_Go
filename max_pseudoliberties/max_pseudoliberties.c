...
int main(int argc, char **argv)
{
  ...
  unsigned long max_states_table[19] = {1, 7, 16, 44, 127, 365, 1049, 3020,
					8725, 25314, 73792, 216156, 636244,
					1881521, 5588883, 16670776, 49920597,
					150029054, 452403148};
...
#define STONE_BITS       (UINT64_C(0x124924924924924))
	...
	new_state = state;
	new_liberties = 0;
	if (down == EMPTY || down == LIBERTY) {
	  new_state |= liberty_bit >> 3;
	  new_liberties++;
	}
	if (left == EMPTY || left == LIBERTY)
	  new_liberties++;
